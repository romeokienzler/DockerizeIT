...
docker run -it --net=host --ipc=host -e DISPLAY=$DISPLAY \
    ...
    --group-add $(getent group audio | cut -d: -f3) \-v /home/romeokienzler:/shared --workdir /shared -v /tmp/.X11-unix:/tmp/.X11-unix --env="QT_X11_NO_MITSHM=1" --device /dev/snd  audacity
